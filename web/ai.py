...
def best_route(starting_location, collection, 
    ...
    return  route(starting_location, collection, desert_storm_1, desert_storm_2, desert_storm_3, desert_storm_4, reward_grid) +  route(collection, ending_location, desert_storm_1, desert_storm_2, desert_storm_3, desert_storm_4, reward_grid )[1:]    